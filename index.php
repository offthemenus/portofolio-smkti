...
<head>
  ...
  <meta
    name="description"
    content="Portofolio Rifky — Full-Stack Web Developer." />
  ...
  <script>
    (function () {
      try {
        ...
        /* localStorage tidak tersedia (mode privat, dsb.) — abaikan, pakai tema default. */
      }
    })();
  </script>
  <link
...
<body>
  ...
  <main>
    ...
    <section class="hero" id="beranda">
      <span class="doodle star doodle--left"><i class="ph ph-star-four"></i></span>
      <span class="doodle doodle--right"><i class="ph ph-sparkle"></i></span>
        ...
        <div class="hero-photo" aria-label="Foto profil ilustratif">
          <div class="avatar">
            <svg
              ...
              <path
                d="M120 420q55-45 130-24 74-21 130 24v80H120z"
                fill="#8b6cf0" />
              <path
                d="M164 211q37-50 88-52 50 2 87 52"
                fill="none"
                stroke="#2d3748"
                stroke-width="17"
                stroke-linecap="round" />
          ...
          <div class="speech"><i class="ph ph-heart"></i></div>
        </div>

        <div class="hero-copy" id="tentang">
          <div class="eyebrow">@n11790i0</div>
          <h2 id="heroName">Rifky Adi Pranata</h2>
          <div
            class="role"
            id="roleText"
          ...
          <div class="location"><i class="ph ph-map-pin"></i> Indonesia</div>
          <div class="actions">
            <a class="btn btn-primary" href="#karya">Lihat Karya <i class="ph ph-arrow-right"></i></a>
            <a
              class="btn btn-secondary"
              href="mailto:25_rifkyadi@student.smkti.net">Hubungi Saya</a>
          </div>
        </div>
      </div>
    </section>
    ...
    <div class="marquee" aria-hidden="true">
      <div class="marquee-track">
        <div class="marquee-group">
          <span>React</span><i>&#10022;</i><span class="outline">Laravel</span><i>&#10022;</i><span>Spring Boot</span><i>&#10022;</i><span class="outline">MySQL</span><i>&#10022;</i><span>PostgreSQL</span><i>&#10022;</i><span class="outline">MongoDB</span><i>&#10022;</i>
        </div>
      </div>
    </div>
    ...
    <section id="pendidikan">
      <div class="container">
        <div class="section-head">
          <div>
            <div class="sec-meta">
              <span class="sec-num">01</span><span class="sec-line"></span>
            </div>
            <h2>Pendidikan <i class="ph ph-graduation-cap"></i></h2>
            <p>Riwayat pendidikan formal saya.</p>
          </div>
        </div>
        <div class="panel lavender reveal">
          <div class="edu-card">
            <div class="edu-icon"><i class="ph ph-graduation-cap"></i></div>
            <div class="edu-text">
    ...
    <section id="skill">
      <div class="container two-col">
        <div class="panel mint reveal">
          <div class="sec-meta">
            <span class="sec-num">02</span><span class="sec-line"></span>
          </div>
          <h2>Skill <i class="ph ph-sparkle"></i></h2>
          <div class="skill-list">
            <div class="skill">
              <div class="skill-icon"><i class="ph ph-atom"></i></div>
              <div class="skill-name">React</div>
              <div class="dots" aria-label="5 dari 6">
                <i class="dot on"></i><i class="dot on"></i><i class="dot on"></i><i class="dot on"></i><i class="dot on"></i><i class="dot"></i>
              </div>
            </div>
            <div class="skill">
              <div class="skill-icon"><i class="ph ph-package"></i></div>
              <div class="skill-name">Laravel</div>
              <div class="dots" aria-label="3 dari 6">
                <i class="dot on"></i><i class="dot on"></i><i class="dot on"></i><i class="dot"></i><i class="dot"></i><i class="dot"></i>
              </div>
            </div>
            <div class="skill">
              <div class="skill-icon"><i class="ph ph-leaf"></i></div>
            ...
            <div class="skill">
              <div class="skill-icon"><i class="ph ph-database"></i></div>
            ...
            <div class="skill">
              <div class="skill-icon"><i class="ph ph-stack"></i></div>
              <div class="skill-name">PostgreSQL</div>
              <div class="dots" aria-label="4 dari 6">
                <i class="dot on"></i><i class="dot on"></i><i class="dot on"></i><i class="dot on"></i><i class="dot"></i><i class="dot"></i>
              </div>
            </div>
            <div class="skill">
              <div class="skill-icon"><i class="ph ph-plant"></i></div>
        ...
        <div class="panel lavender reveal">
          <div class="section-head">
            <div>
              <h2>Progress Belajar <i class="ph ph-star"></i></h2>
            </div>
          </div>
          <div class="course-list">
            <article class="course">
              <div class="course-icon course-icon--react">
                <i class="ph ph-atom"></i>
              </div>
              <div>
                <p class="course-title">
                  React <span class="badge">Selesai</span>
                </p>
                <div class="course-meta">
                  <span>Complete</span><span data-target="100">100%</span>
                </div>
                <div class="bar"><span data-w="100"></span></div>
              </div>
            </article>
            <article class="course">
              <div class="course-icon course-icon--spring">
                <i class="ph ph-leaf"></i>
              </div>
              <div>
                <p class="course-title">
                  Spring Boot
                  <span class="badge badge--amber">Sedang Belajar</span>
                </p>
                <div class="course-meta">
                  <span>Progress</span><span data-target="40">40%</span>
                </div>
    ...
    <section id="karya">
      <div class="container">
        <div class="section-head">
          <div>
            <div class="sec-meta">
              <span class="sec-num">03</span><span class="sec-line"></span>
            </div>
            <h2>Karya Terpilih <i class="ph ph-code"></i></h2>
        ...
        <div class="projects">
          <a
            class="card reveal"
            href="https://test-mvc-framework.freedev.app/"
            target="_blank"
            rel="noopener"
            aria-label="Project Chirp App">
            <div class="thumb thumb--lavender">
          ...
          <a
            class="card reveal"
            href="#hall-of-creations"
            aria-label="Project REST API">
            <div class="thumb thumb--peach">
              <svg viewBox="0 0 400 400">
            ...
            <div class="card-body">
              <h3>REST API</h3>
              <span class="tag green">Spring Boot</span>
            </div>
          </a>
          ...
          <a
            class="card reveal"
            href="#hall-of-creations"
            aria-label="Project Memory Game">
            <div class="thumb thumb--mint">
              <svg viewBox="0 0 400 400">
          ...
          <a
            class="card reveal"
            href="#hall-of-creations"
            aria-label="Project Portofolio">
            <div class="thumb thumb--rose">
              <svg viewBox="0 0 400 400">
    ...
    <section id="hall-of-creations">
      <div class="container">
        <div class="cta reveal">
          ...
          <div>
            <div class="sec-meta">
              <span class="sec-num">04</span><span class="sec-line"></span>
            </div>
            <h2>Hall of Creations <i class="ph ph-heart"></i></h2>
            <p>Tempat semua karya, proyek, dan cerita pengembangan saya.</p>
          </div>
          <a
            class="btn btn-primary"
            href="https://dooptech.my.id/hall-of-creations/portofolio-rifky"
            target="_blank"
            rel="noopener">Kunjungi Hall of Creations <i class="ph ph-arrow-right"></i></a>
        </div>
      </div>
    </section>
  </main>
  ...
  <footer>
    <div class="container footer-inner">
      ...
      <a
        class="footer-mail"
        href="mailto:25_rifkyadi@student.smkti.net"
        aria-label="Kirim email ke Rifky">
      ...
      <div class="footer-base">
        ...
        <span>
          Made with <span class="heart"><i class="ph ph-heart"></i></span>
          &amp; lots of code
        </span>
      </div>
    </div>
  ...
  <script
    ...
    defer></script>
  <script
    src="https://unpkg.com/gsap@3.13.0/dist/SplitText.min.js"
    defer></script>
  <script
